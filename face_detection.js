...
////////////adding the remaining layers with double the filters
model.add(tf.layers.conv2d({
    kernelSize: 5,
    filters: 16,
    strides: 1,
...
tf.run_cascade = function(image, classify_region, params)
{
...
tf.cluster_detections = function(dets, iouthreshold)
{
    /*
...
tf.instantiate_detection_memory = function(size)
{
    /*
